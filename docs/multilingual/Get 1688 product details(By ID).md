[Skip to main content](https://tmapi.top/docs/ali/multi-language-apis/get-item-detail-by-id/#__docusaurus_skipToContent_fallback)

note

This API has been merged with [/1688/item/detail API](https://tmapi.top/docs/ali/item-detail/get-item-detail-by-id). Please use that API to get multilingual product details.

## API Overview [​](https://tmapi.top/docs/ali/multi-language-apis/get-item-detail-by-id/\#api-overview "Direct link to API Overview")

- Get 1688 multilingual product details by product ID

## Basic Information [​](https://tmapi.top/docs/ali/multi-language-apis/get-item-detail-by-id/\#basic-information "Direct link to Basic Information")

API URL

GET

http://api.tmapi.top/1688/global/item\_detail

## Request Parameter [​](https://tmapi.top/docs/ali/multi-language-apis/get-item-detail-by-id/\#request-parameter "Direct link to Request Parameter")

### Query [​](https://tmapi.top/docs/ali/multi-language-apis/get-item-detail-by-id/\#query "Direct link to Query")
...
### Body [​](https://tmapi.top/docs/ali/multi-language-apis/get-item-detail-by-id/\#body "Direct link to Body")

## Security Auth [​](https://tmapi.top/docs/ali/multi-language-apis/get-item-detail-by-id/\#security-auth "Direct link to Security Auth")
...
## Request Example [​](https://tmapi.top/docs/ali/multi-language-apis/get-item-detail-by-id/\#request-example "Direct link to Request Example")
...
## Response Example [​](https://tmapi.top/docs/ali/multi-language-apis/get-item-detail-by-id/\#response-example "Direct link to Response Example")
