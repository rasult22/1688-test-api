[Skip to main content](https://tmapi.top/docs/ali/item-detail/get-item-detail-by-id/#__docusaurus_skipToContent_fallback)

## API Overview [​](https://tmapi.top/docs/ali/item-detail/get-item-detail-by-id/\#api-overview "Direct link to API Overview")
...
## Basic Information [​](https://tmapi.top/docs/ali/item-detail/get-item-detail-by-id/\#basic-information "Direct link to Basic Information")

API URL

GET

http://api.tmapi.top/1688/item\_detail

## Request Parameter [​](https://tmapi.top/docs/ali/item-detail/get-item-detail-by-id/\#request-parameter "Direct link to Request Parameter")

### Query [​](https://tmapi.top/docs/ali/item-detail/get-item-detail-by-id/\#query "Direct link to Query")
...
| language | string | Optional values: `en`,<br>`zh`,`ru`,`th`,`pt`,<br>`es`,`tr`,`vi`,`ja`,<br>`ko`<br>Default value: zh | false |

### Body [​](https://tmapi.top/docs/ali/item-detail/get-item-detail-by-id/\#body "Direct link to Body")

## Security Auth [​](https://tmapi.top/docs/ali/item-detail/get-item-detail-by-id/\#security-auth "Direct link to Security Auth")
...
## Request Example [​](https://tmapi.top/docs/ali/item-detail/get-item-detail-by-id/\#request-example "Direct link to Request Example")
...
curl_setopt_array($curl, [\
  CURLOPT_URL => "http://api.tmapi.top/1688/item_detail?apiToken=xxxxxx&item_id=652702302959&language=zh",\
...
const options = {
  ...
  params: {apiToken: 'xxxxxx', item_id: 652702302959, language: 'zh'}
};
...
querystring = {"apiToken":"xxxxxx","item_id":652702302959,"language":"zh"}
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("http://api.tmapi.top/1688/item_detail?apiToken=xxxxxx&item_id=652702302959&language=zh"))
...
func main() {
	...
	url := "http://api.tmapi.top/1688/item_detail?apiToken=xxxxxx&item_id=652702302959&language=zh"
...
## Response Example [​](https://tmapi.top/docs/ali/item-detail/get-item-detail-by-id/\#response-example "Direct link to Response Example")
